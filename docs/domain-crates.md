...
Each domain implements `Situation`, `Action`, and `Precondition` from `praxis`. All domains live in the `praxis-domains` crate, organized by category.
...
## systems::communication::protocols::http
...
## systems::transportation::elevator
