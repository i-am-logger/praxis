...
"##;
    ...
    fn test_scan_all_datasets() {
        ...
        for (name, dir) in &datasets {
            ...
            println!(
                "║  {} ({} themes: {} dark, {} light)",
                name, total, dark, light
            );
            println!(
                "║    Luminance monotone: {} ({:.0}%)",
                mono,
                mono as f64 / total as f64 * 100.0
            );
            println!(
                "║    WCAG AA compliant:  {} ({:.0}%)",
                wcag,
                wcag as f64 / total as f64 * 100.0
            );
        ...
        if grand_total > 0 {
            println!(
                "║    Luminance monotone: {} ({:.0}%)",
                grand_mono,
                grand_mono as f64 / grand_total as f64 * 100.0
            );
            println!(
                "║    WCAG AA compliant:  {} ({:.0}%)",
                grand_wcag,
                grand_wcag as f64 / grand_total as f64 * 100.0
            );
        }
        println!("╚═══════════════════════════════════════════════════════════╝\n");
