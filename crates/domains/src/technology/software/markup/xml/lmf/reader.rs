use super::ontology::*;
use crate::technology::software::markup::xml::ontology::XmlNode;
use crate::technology::software::markup::xml::reader as xml_reader;
...
fn read_lexical_entry(
    elem: &crate::technology::software::markup::xml::ontology::XmlElement,
) -> Option<LexicalEntry> {
    let id = elem
        .attributes
        .iter()
