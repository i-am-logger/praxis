use crate::technology::sensor_fusion::sensor::characteristic::{
    ...
    pub fn tactical_accelerometer() -> Self {
        Self {
            ...
            characteristics: SensorCharacteristics {
                ...
                measurement_range: (
                    -300.0 * crate::science::math::quantity::constants::standard_gravity().value,
                    300.0 * crate::science::math::quantity::constants::standard_gravity().value,
                ),
                typical_noise_density: 50e-6
                    * crate::science::math::quantity::constants::standard_gravity().value,
            },
