...
/// (see `crate::science::math::control_theory`):
    ...
    match action {
        ...
        FusionAction::Update {
            ...
            for i in 0..pht.rows {
                ...
                let solved =
                    crate::science::math::linear_algebra::decomposition::solve_spd(&s, &col)
                        .ok_or_else(|| {
            ...
            let p_new =
                crate::science::math::linear_algebra::positive_definite::joseph_update(p, &k, h, r);
