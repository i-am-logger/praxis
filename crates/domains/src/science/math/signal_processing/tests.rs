...
use crate::science::math::signal_processing::ontology::*;
...
mod proptest_proofs {
    ...
    use crate::science::math::signal_processing::sampling;
    use crate::science::math::signal_processing::spectrum::{self, SpectralBand};
