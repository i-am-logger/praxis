...
use crate::science::math::geometry::ontology::*;
...
fn plane_project_point_zero_normal_no_panic() {
    use crate::science::math::geometry::plane::Plane;
    use crate::science::math::geometry::point::Point3;
    use crate::science::math::geometry::vector::Vec3;
...
#[cfg(test)]
mod proptest_proofs {
    use crate::science::math::geometry::distance;
    use crate::science::math::geometry::point::{Point2, Point3};
    use crate::science::math::geometry::projection;
    use crate::science::math::geometry::shape::Triangle;
    use crate::science::math::geometry::vector::Vec3;
