...
impl Point2 {
    ...
    pub fn vector_to(&self, other: &Self) -> crate::science::math::geometry::vector::Vec2 {
        crate::science::math::geometry::vector::Vec2 {
            x: other.x - self.x,
            y: other.y - self.y,
        }
    }
    ...
    pub fn translate(&self, v: &crate::science::math::geometry::vector::Vec2) -> Self {
        Self {
            x: self.x + v.x,
            y: self.y + v.y,
        }
...
impl Point3 {
    ...
    /// Vector from self to other.
    pub fn vector_to(&self, other: &Self) -> crate::science::math::geometry::vector::Vec3 {
        crate::science::math::geometry::vector::Vec3 {
            x: other.x - self.x,
            y: other.y - self.y,
            z: other.z - self.z,
        }
    ...
    /// Translate by a vector.
    pub fn translate(&self, v: &crate::science::math::geometry::vector::Vec3) -> Self {
        Self {
            x: self.x + v.x,
            y: self.y + v.y,
            z: self.z + v.z,
