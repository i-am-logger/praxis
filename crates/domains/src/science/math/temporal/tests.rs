...
use crate::science::math::temporal::ontology::*;
...
#[cfg(test)]
mod proptest_proofs {
    use crate::science::math::temporal::allen;
    use crate::science::math::temporal::duration::Duration;
    use crate::science::math::temporal::instant::Instant;
    use crate::science::math::temporal::interval::Interval;
    ...
    proptest! {
        ...
        fn gps_tai_roundtrip(t in 0.0..1e9_f64) {
            use crate::science::math::temporal::time_system;
