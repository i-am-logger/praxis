...
impl Velocity {
    ...
    pub fn displace(&self, dt: f64) -> crate::science::math::geometry::vector::Vec3 {
        crate::science::math::geometry::vector::Vec3::new(self.vx * dt, self.vy * dt, self.vz * dt)
    }
    ...
    pub fn acceleration_to(
        ...
        other: &Self,
        dt: f64,
    ) -> Option<crate::science::physics::kinematics::acceleration::Acceleration> {
        if dt.abs() < 1e-15 {
            return None;
        }
        Some(
            crate::science::physics::kinematics::acceleration::Acceleration {
