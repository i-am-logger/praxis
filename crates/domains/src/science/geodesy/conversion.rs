use crate::science::geodesy::coordinate::{Ecef, Geodetic, Ned};
use crate::science::geodesy::ellipsoid::Ellipsoid;
...
pub fn ecef_to_ned(ecef: &Ecef, ref_point: &Geodetic) -> Ned {
    let ref_ecef = geodetic_to_ecef(ref_point, &crate::science::geodesy::ellipsoid::wgs84());
