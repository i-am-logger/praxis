use crate::decision::{Decision, MotionAction};
use crate::entity::Entity;
use crate::finding::Ruling;
    ...
    pub fn act(&mut self, action: CaseAction) -> ActionResult {
        match action {
            ...
            CaseAction::FileMotion { motion } => {
                ...
                self.event(chrono::Utc::now().date_naive(), "Motion filed")
            }
            ...
            CaseAction::RuleOnMotion {
                ...
                match self.motions[motion_index].act(motion_action) {
                    Ok(advanced) => {
                        ...
                        self.event(chrono::Utc::now().date_naive(), "Motion ruled")
                    }
